...
update_time
echo -n "kubectl drain kind-worker2 --ignore-daemonsets --delete-emptydir-data,drain kind-worker3,${CDT},${UTC}," >> ${fn}
...
update_time
echo -n "kubectl uncordon kind-worker2,uncordon kind-worker3,${CDT},${UTC}," >> ${fn}
